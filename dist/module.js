...
/*!****************************!*\
  !*** ./GlobalVariables.ts ***!
  \****************************/
/*! exports provided: PAGINATION_LIMIT, CACHE_MAX_AGE, SEPARATOR, BUILT_IN_METRICS, CUSTOM_METRICS, ANALYZE_APPLICATION_METRICS, ANALYZE_WEBSITE_METRICS, APPLICATION_SERVICE_ENDPOINT_METRICS, SLO_INFORMATION, INFRASTRUCTURE_ANALYZE, ANALYZE_MOBILE_APP_METRICS, ALL_APPLICATIONS, ALL_WEBSITES, ALL_MOBILE_APPS, ALL_SERVICES, ALL_ENDPOINTS, PLEASE_SPECIFY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function () {
  ...
  DataSourceInfrastructure.prototype.fetchSnapshotsForTarget = function (target, timeFilter) {
    ...
    var fetchSnapshotContextsUrl = "/api/infrastructure-monitoring/snapshots" + ("?plugin=" + target.entityType.key) + '&size=100' + ("&query=" + target.entityQuery) + ("&from=" + timeFilter.from) + ("&to=" + timeFilter.to) + (this.instanaOptions.showOffline ? "" : "&time=" + timeFilter.to);
    snapshots = Object(_util_request_handler__WEBPACK_IMPORTED_MODULE_2__["getRequest"])(this.instanaOptions, fetchSnapshotContextsUrl).then(function (contextsResponse) {
      return Promise.all(contextsResponse.data.items.map(function (_a) {
        ...
        var fetchSnapshotUrl = "/api/infrastructure-monitoring/snapshots/" + snapshotId + (_this.instanaOptions.showOffline ? "?from=" + timeFilter.from + "&to=" + timeFilter.to : "?time=" + timeFilter.to); // @see SnapshotApiResource#getSnapshot
  ...
  DataSourceInfrastructure.prototype.fetchMetricsForSnapshot = function (target, snapshotIds, timeFilter, metric) {
    ...
    return Object(_util_request_handler__WEBPACK_IMPORTED_MODULE_2__["postRequest"])(this.instanaOptions, '/api/infrastructure-monitoring/metrics', data);
  };
