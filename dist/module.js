...
/*!****************************!*\
  !*** ./GlobalVariables.ts ***!
  \****************************/
/*! exports provided: PAGINATION_LIMIT, CACHE_MAX_AGE, SEPARATOR, BUILT_IN_METRICS, CUSTOM_METRICS, ANALYZE_APPLICATION_METRICS, ANALYZE_WEBSITE_METRICS, APPLICATION_SERVICE_ENDPOINT_METRICS, SLO_INFORMATION, INFRASTRUCTURE_EXPLORE, ALL_APPLICATIONS, ALL_WEBSITES, ALL_SERVICES, ALL_ENDPOINTS, PLEASE_SPECIFY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _plugin_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./plugin.css */ "./components/plugin.css");
/* harmony import */ var _plugin_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_plugin_css__WEBPACK_IMPORTED_MODULE_6__);
...
function (_super) {
  ...
  ConfigEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "settings"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Legend"], null, "Instana configuration"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Field"], {
      className: 'width-30',
      horizontal: true,
      required: true,
      label: "URL",
      ...
      suffix: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Tooltip"], {
        content: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "You can create API tokens following the instructions at\xA0", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
...
/* harmony import */ var _SLOInformation_SloInformation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./SLOInformation/SloInformation */ "./components/SLOInformation/SloInformation.tsx");
/* harmony import */ var _Analyze_WebsiteMetrics__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Analyze/WebsiteMetrics */ "./components/Analyze/WebsiteMetrics.tsx");
...
/* harmony import */ var _util_time_util__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../util/time_util */ "./util/time_util.ts");
...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.updateMetrics = function (metrics) {
      _this.setState({
        availableMetrics: lodash__WEBPACK_IMPORTED_MODULE_17___default.a.sortBy(metrics, 'key'),
        allMetrics: lodash__WEBPACK_IMPORTED_MODULE_17___default.a.sortBy(metrics, 'key')
      });

      if (_this.query.metric && _this.query.metric.key || _this.query.showAllMetrics) {
        var metric = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.find(metrics, function (m) {
    ...
    _this.filterForEntityType = function (findMatchingEntityTypes, filterResults) {
      ...
      datasource.getEntityTypes().then(function (entityTypes) {
        ...
        if (!query.entityType || !query.entityType.key || !lodash__WEBPACK_IMPORTED_MODULE_17___default.a.find(queryTypes, function (m) {
    ...
    _this.filterEntityTypes = function (entityTypes, findMatchingEntityTypes) {
      if (findMatchingEntityTypes) {
        return lodash__WEBPACK_IMPORTED_MODULE_17___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_17___default.a.filter(entityTypes, function (entityType) {
          return _this.findMatchingEntityTypes(entityType);
        }), 'label');
      }

      return lodash__WEBPACK_IMPORTED_MODULE_17___default.a.sortBy(entityTypes, 'label');
    };
    ...
    var defaultQuery = {
      metricCategory: _lists_metric_categories__WEBPACK_IMPORTED_MODULE_18__["default"][0],
      timeShiftIsValid: true,
      customFilters: []
    };
    _this.query = Object.assign(defaultQuery, props.query);
    Object(_migration__WEBPACK_IMPORTED_MODULE_19__["default"])(_this.query);
    _this.state = {
      groups: [],
      allMetrics: [],
      queryTypes: [],
      availableMetrics: [],
      selectedWindowSize: props.range ? Object(_util_time_util__WEBPACK_IMPORTED_MODULE_20__["readTime"])(props.range).windowSize : 21600000
    };
  ...
  QueryEditor.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
    ...
    if (range && this.state.selectedWindowSize !== Object(_util_time_util__WEBPACK_IMPORTED_MODULE_20__["readTime"])(range).windowSize) {
      this.setState(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.state), {
        selectedWindowSize: Object(_util_time_util__WEBPACK_IMPORTED_MODULE_20__["readTime"])(range).windowSize
      }));
  ...
  QueryEditor.prototype.applyFilterToMetricList = function (filters) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(filters, function (filter) {
      if (filter !== '') {
        filteredMetrics = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_17___default.a.filter(filteredMetrics, function (metric) {
  ...
  QueryEditor.prototype.checkMetricAndRefresh = function () {
    if (this.query.metric && this.query.metric.key && !lodash__WEBPACK_IMPORTED_MODULE_17___default.a.includes(lodash__WEBPACK_IMPORTED_MODULE_17___default.a.map(this.state.availableMetrics, function (m) {
      return m.key;
  ...
  QueryEditor.prototype.render = function () {
    ...
    var categories = this.allowInfraExplore ? _lists_metric_categories__WEBPACK_IMPORTED_MODULE_18__["default"] : _lists_metric_categories__WEBPACK_IMPORTED_MODULE_18__["default"].filter(function (category) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      ...
      datasource: this.props.datasource
    }), query.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["ANALYZE_WEBSITE_METRICS"] && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Analyze_WebsiteMetrics__WEBPACK_IMPORTED_MODULE_16__["WebsiteMetrics"], {
      query: query,
      onRunQuery: this.props.onRunQuery,
      onChange: this.props.onChange,
      updateMetrics: this.updateMetrics,
      ...
      updateMetrics: this.updateMetrics,
      datasource: this.props.datasource
    }), query.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["SLO_INFORMATION"] && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_SLOInformation_SloInformation__WEBPACK_IMPORTED_MODULE_15__["SloInformation"], {
      query: query,
      onRunQuery: this.props.onRunQuery,
      onChange: this.props.onChange,
      datasource: this.props.datasource
...
function (_super) {
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        , Promise.all(options.targets.map(function (target) {
          ...
          if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["SLO_INFORMATION"]) {
          ...
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["INFRASTRUCTURE_EXPLORE"]) {
          ...
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["BUILT_IN_METRICS"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["CUSTOM_METRICS"]) {
            return _this.dataSourceInfrastructure.runQuery(target, targetTimeFilter).then(function (data) {
              return _this.buildTargetWithAppendedDataResult(target, targetTimeFilter, data);
            });
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["ANALYZE_WEBSITE_METRICS"]) {
            return _this.dataSourceWebsite.runQuery(target, targetTimeFilter).then(function (data) {
              return _this.buildTargetWithAppendedDataResult(target, targetTimeFilter, data);
            });
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["ANALYZE_APPLICATION_METRICS"]) {
            return _this.dataSourceApplication.runQuery(target, targetTimeFilter).then(function (data) {
              return _this.buildTargetWithAppendedDataResult(target, targetTimeFilter, data);
            });
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["APPLICATION_SERVICE_ENDPOINT_METRICS"]) {
          ...
          lodash__WEBPACK_IMPORTED_MODULE_8___default.a.each(targetData, function (targetAndData) {
            ...
            _this.cacheResultIfNecessary(lodash__WEBPACK_IMPORTED_MODULE_8___default.a.cloneDeep(resultData), targetAndData.target); // clone to store results without timeshift re-calculation
  ...
  DataSource.prototype.supportsDeltaRequests = function (target) {
    ...
    if (target.metricCategory) {
      if (target.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["SLO_INFORMATION"] || target.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["INFRASTRUCTURE_EXPLORE"]) {
        return false;
      }
    }
  ...
  DataSource.prototype.adjustTimeFilterIfCached = function (timeFilter, target) {
    ...
    if (cachedResult && Object(_util_delta_util__WEBPACK_IMPORTED_MODULE_11__["hasIntersection"])(timeFilter, cachedResult.timeFilter)) {
      var newFrom = Object(_util_delta_util__WEBPACK_IMPORTED_MODULE_11__["getDeltaRequestTimestamp"])(cachedResult.results, cachedResult.timeFilter.from, target.timeInterval);
  ...
  DataSource.prototype.getDefaultTimeInterval = function (query) {
    ...
    if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["BUILT_IN_METRICS"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["CUSTOM_METRICS"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_12__["INFRASTRUCTURE_EXPLORE"]) {
  ...
  DataSource.prototype.testDatasource = function () {
    return Object(_util_request_handler__WEBPACK_IMPORTED_MODULE_2__["getRequest"])(this.options, '/api/infrastructure-monitoring/monitoring-state').then(function () {
      return {
        status: 'success',
