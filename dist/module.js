...
function () {
  ...
  DataSourceInfrastructure.prototype.buildLabel = function (snapshotResponse, host, target, index, metric) {
    if (target.labelFormat) {
      ...
      label = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.replace(label, '$pid', lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(snapshotResponse, ['data', 'pid'], ''));
      label = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.replace(label, '$type', lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(snapshotResponse, ['data', 'type'], ''));
