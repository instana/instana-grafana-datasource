...
function (_super) {
  ...
  function ConfigEditor(props) {
    ...
    _this.detectFeatures(props);

    return _this;
  }

  ConfigEditor.prototype.detectFeatures = function (props) {
    var _this = this;
    ...
    Object(_util_instana_version__WEBPACK_IMPORTED_MODULE_3__["default"])(options.jsonData.url, options.jsonData.apiToken).then(function (version) {
  ...
  ConfigEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h4", null, "Instana configuration"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["FormField"], {
      label: "URL",
      labelWidth: 14,
      inputWidth: 30,
      value: jsonData.url,
      ...
      tooltip: 'Enter the API token to access the data. You can create API tokens following the instructions at https://docs.instana.io/quick_start/api/#api-tokens'
      ...
      tooltip: 'Use Grafana server as proxy, this adds the Instana API token on the server. Supported with Grafana 5.3+ and Instana datasource 2.0.0+'
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Switch"], {
    ...
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("b", null, "Maximum query intervals in hours"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "This settings are optional values to control the load of data queries, by defining the maximum allowed query intervals against the Instana API."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["FormField"], {
        ...
        data = options.targets.map(function (target) {
          ...
          return new _grafana_data__WEBPACK_IMPORTED_MODULE_2__["MutableDataFrame"]({
            ...
            fields: [{
              ...
              name: 'Value',
              values: [query.constant, query.constant],
...
function getVersion(baseUrl, apiToken) {
  var version = versionCache.get('version');

  if (version) {
    return version;
  }

  version = Object(_request_handler__WEBPACK_IMPORTED_MODULE_1__["doRequest"])(baseUrl + '/api/instana/version', apiToken).then(function (result) {
...
/*!*********************************!*\
  !*** ./util/request_handler.ts ***!
  \*********************************/
/*! exports provided: doRequest, postRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "doRequest", function() { return doRequest; });
...
function doRequest(url, apiToken, swallowError, maxRetries) {
...
function postRequest(url, apiToken, data, swallowError, maxRetries) {
  if (swallowError === void 0) {
    swallowError = false;
  }
...
function execute(request, apiToken, swallowError, maxRetries) {
  if (apiToken) {
    request['headers'] = {
