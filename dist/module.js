  ...
  function QueryEditor(props) {
    ...
    _this.filterForEntityType = function (findMatchingEntityTypes, filterResults) {
      ...
      datasource.getEntityTypes().then(function (entityTypes) {
        ...
        if (!query.entityType || !query.entityType.key || !lodash__WEBPACK_IMPORTED_MODULE_20___default.a.find(queryTypes, function (m) {
    ...
    _this.filterEntityTypes = function (entityTypes, findMatchingEntityTypes) {
      if (findMatchingEntityTypes) {
        return lodash__WEBPACK_IMPORTED_MODULE_20___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_20___default.a.filter(entityTypes, function (entityType) {
          return _this.findMatchingEntityTypes(entityType);
        }), 'label');
      }

      return lodash__WEBPACK_IMPORTED_MODULE_20___default.a.sortBy(entityTypes, 'label');
    };
...
/* harmony import */ var _DataSource_SyntheticMonitoring__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./DataSource_SyntheticMonitoring */ "./datasources/DataSource_SyntheticMonitoring.ts");
/* harmony import */ var _lists_metric_categories__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../lists/metric_categories */ "./lists/metric_categories.ts");
...
/* harmony import */ var _util_aggregation_util__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../util/aggregation_util */ "./util/aggregation_util.ts");
/* harmony import */ var _util_target_util__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../util/target_util */ "./util/target_util.ts");
/* harmony import */ var _util_instana_version__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../util/instana_version */ "./util/instana_version.ts");
/* harmony import */ var _util_queryInterval_check__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../util/queryInterval_check */ "./util/queryInterval_check.ts");
/* harmony import */ var _migration__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../migration */ "./migration.ts");
/* harmony import */ var _util_analyze_util__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../util/analyze_util */ "./util/analyze_util.ts");
...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.dataSourceSyntheticMonitoring = new _DataSource_SyntheticMonitoring__WEBPACK_IMPORTED_MODULE_16__["DataSourceSyntheticMonitoring"](instanceSettings.jsonData);
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        , Promise.all(options.targets.map(function (target) {
          ...
          Object(_migration__WEBPACK_IMPORTED_MODULE_23__["default"])(target);

          if (!target.metricCategory) {
            target.metricCategory = _lists_metric_categories__WEBPACK_IMPORTED_MODULE_17__["default"][0];
          }
          ...
          return Promise.resolve(Object(_util_target_util__WEBPACK_IMPORTED_MODULE_20__["emptyResultData"])(target.refId));
        })).then(function (targetData) {
          var result = [];

          lodash__WEBPACK_IMPORTED_MODULE_18___default.a.each(targetData, function (targetAndData) {
            // Flatten the list as Grafana expects a list of targets with corresponding datapoints.
            var resultData = lodash__WEBPACK_IMPORTED_MODULE_18___default.a.compact(lodash__WEBPACK_IMPORTED_MODULE_18___default.a.flatten(targetAndData.data)); // Also remove empty data items


            _this.cacheResultIfNecessary(lodash__WEBPACK_IMPORTED_MODULE_18___default.a.cloneDeep(resultData), targetAndData.target); // clone to store results without timeshift re-calculation
          ...
          return {
            data: lodash__WEBPACK_IMPORTED_MODULE_18___default.a.flatten(result)
          };
        })];
      });
    });
  ...
  DataSource.prototype.getApplicationServiceEndpointMetrics = function (target, timeFilter) {
    ...
    if (Object(_util_queryInterval_check__WEBPACK_IMPORTED_MODULE_22__["isInvalidQueryInterval"])(timeFilter.windowSize, Object(_util_time_util__WEBPACK_IMPORTED_MODULE_6__["hoursToMs"])(this.options.queryinterval_limit_app_metrics))) {
    ...
    if (target.endpoint && target.endpoint.key) {
      return this.dataSourceEndpoint.fetchEndpointMetrics(target, timeFilter).then(function (response) {
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_24__["readItemMetrics"])(target, response, _this.dataSourceEndpoint.buildEndpointMetricLabel);
      });
      ...
      return this.dataSourceService.fetchServiceMetrics(target, timeFilter).then(function (response) {
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_24__["readItemMetrics"])(target, response, _this.dataSourceService.buildServiceMetricLabel);
      });
      ...
      return this.dataSourceApplication.fetchApplicationMetrics(target, timeFilter).then(function (response) {
        ...
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_24__["readItemMetrics"])(target, response, _this.dataSourceApplication.buildApplicationMetricLabel);
      });
    }
  ...
  DataSource.prototype.supportsDeltaRequests = function (target) {
    ...
    if (!version) {
      return Object(_util_instana_version__WEBPACK_IMPORTED_MODULE_21__["default"])(this.options).then(function (version) {
  ...
  DataSource.prototype.aggregateDataIfNecessary = function (data, target) {
    ...
    if (target.aggregateGraphs) {
      var aggregatedData_1 = Object(_util_aggregation_util__WEBPACK_IMPORTED_MODULE_19__["aggregateTarget"])(data, target);
      newData.push(aggregatedData_1);

      if (!target.hideOriginalGraphs) {
        lodash__WEBPACK_IMPORTED_MODULE_18___default.a.each(data, function (dt) {
...
function () {
  ...
  DataSourceInfrastructure.prototype.runQuery = function (target, timeFilter) {
    ...
    if (target.tagFilterExpression || target.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["INFRASTRUCTURE_ANALYZE"] && target.metric.key && target.group.key && target.entity.key) {
  ...
  DataSourceInfrastructure.prototype.getMetricsCatalog = function (plugin, metricCategory) {
    ...
    metrics = Object(_util_request_handler__WEBPACK_IMPORTED_MODULE_3__["getRequest"])(this.instanaOptions, "/api/infrastructure-monitoring/catalog/metrics/" + plugin.key + "?filter=" + filter).then(function (catalogResponse) {
      return catalogResponse.data.map(function (entry) {
        return {
          key: entry.metricId,
          label: entry.label,
  ...
  DataSourceInfrastructure.prototype.fetchSnapshotsForTarget = function (target, timeFilter) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var windowSize, query, key, snapshots, fetchSnapshotContextsUrl;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        fetchSnapshotContextsUrl = "/api/infrastructure-monitoring/snapshots" + ("?plugin=" + target.entityType.key) + "&size=100" + ("&query=" + target.entityQuery) + ("&windowSize=" + Object(_util_time_util__WEBPACK_IMPORTED_MODULE_2__["atLeastGranularity"])(windowSize, target.timeInterval.key)) + ("&to=" + timeFilter.to) + ("&offline=" + this.instanaOptions.showOffline);
