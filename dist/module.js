...
function () {
  ...
  DataSourceSlo2.prototype.extractSpecificValueFromSLI = function (target, sloResult, timeFilter) {
    if (target.slo2Specific.key === 'Status') {
      return [Object(_util_target_util__WEBPACK_IMPORTED_MODULE_0__["buildTimeSeries"])(target.slo2Specific.label, target.refId, this.buildResultArray(sloResult.sli, timeFilter.to, true))];
    } else if (target.slo2Specific.key === 'Service Level Target') {
      return [Object(_util_target_util__WEBPACK_IMPORTED_MODULE_0__["buildTimeSeries"])(target.slo2Specific.label, target.refId, this.buildResultArray(sloResult.slo, timeFilter.to, true))];
  ...
  DataSourceSlo2.prototype.buildResultArray = function (result, timestamp, asPercentage) {
    if (asPercentage === void 0) {
      asPercentage = false;
    }
