...
/*!****************************!*\
  !*** ./GlobalVariables.ts ***!
  \****************************/
/*! exports provided: PAGINATION_LIMIT, CACHE_MAX_AGE, SEPARATOR, BUILT_IN_METRICS, CUSTOM_METRICS, ANALYZE_APPLICATION_METRICS, ANALYZE_WEBSITE_METRICS, APPLICATION_SERVICE_ENDPOINT_METRICS, SLO_INFORMATION, INFRASTRUCTURE_EXPLORE, ANALYZE_MOBILE_APP_METRICS, ALL_APPLICATIONS, ALL_WEBSITES, ALL_MOBILE_APPS, ALL_SERVICES, ALL_ENDPOINTS, PLEASE_SPECIFY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INFRASTRUCTURE_EXPLORE", function() { return INFRASTRUCTURE_EXPLORE; });
...
function (_super) {
  ...
  AdvancedSettings.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      className: 'gf-form',
      hidden: category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["SLO_INFORMATION"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["INFRASTRUCTURE_EXPLORE"]
...
function (_super) {
  ...
  ConfigEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      ...
      description: 'Beta feature. Adds a new category that allows usage of Infrastructure Explore functionality. Needs Instana release ' + '195+ and an explicit feature flag. If you are interested in this technology, please submit a request via ' + 'our support system at https://support.instana.com/.'
...
/* harmony import */ var _Analyze_WebsiteMetrics__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Analyze/WebsiteMetrics */ "./components/Analyze/WebsiteMetrics.tsx");
...
/* harmony import */ var _lists_metric_categories__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../lists/metric_categories */ "./lists/metric_categories.ts");
/* harmony import */ var _migration__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../migration */ "./migration.ts");
/* harmony import */ var _util_time_util__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../util/time_util */ "./util/time_util.ts");
...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.updateMetrics = function (metrics) {
      _this.setState({
        availableMetrics: lodash__WEBPACK_IMPORTED_MODULE_18___default.a.sortBy(metrics, 'key'),
        allMetrics: lodash__WEBPACK_IMPORTED_MODULE_18___default.a.sortBy(metrics, 'key')
      });

      if (_this.query.metric && _this.query.metric.key || _this.query.showAllMetrics) {
        var metric = lodash__WEBPACK_IMPORTED_MODULE_18___default.a.find(metrics, function (m) {
    ...
    _this.filterForEntityType = function (findMatchingEntityTypes, filterResults) {
      ...
      datasource.getEntityTypes().then(function (entityTypes) {
        ...
        if (!query.entityType || !query.entityType.key || !lodash__WEBPACK_IMPORTED_MODULE_18___default.a.find(queryTypes, function (m) {
    ...
    _this.filterEntityTypes = function (entityTypes, findMatchingEntityTypes) {
      if (findMatchingEntityTypes) {
        return lodash__WEBPACK_IMPORTED_MODULE_18___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_18___default.a.filter(entityTypes, function (entityType) {
          return _this.findMatchingEntityTypes(entityType);
        }), 'label');
      }

      return lodash__WEBPACK_IMPORTED_MODULE_18___default.a.sortBy(entityTypes, 'label');
    };
    ...
    var defaultQuery = {
      metricCategory: _lists_metric_categories__WEBPACK_IMPORTED_MODULE_19__["default"][0],
      timeShiftIsValid: true,
      customFilters: []
    };
    _this.query = Object.assign(defaultQuery, props.query);
    Object(_migration__WEBPACK_IMPORTED_MODULE_20__["default"])(_this.query);
    _this.state = {
      groups: [],
      allMetrics: [],
      queryTypes: [],
      availableMetrics: [],
      selectedWindowSize: props.range ? Object(_util_time_util__WEBPACK_IMPORTED_MODULE_21__["readTime"])(props.range).windowSize : 21600000
    };
  ...
  QueryEditor.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
    ...
    if (range && this.state.selectedWindowSize !== Object(_util_time_util__WEBPACK_IMPORTED_MODULE_21__["readTime"])(range).windowSize) {
      this.setState(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.state), {
        selectedWindowSize: Object(_util_time_util__WEBPACK_IMPORTED_MODULE_21__["readTime"])(range).windowSize
      }));
  ...
  QueryEditor.prototype.applyFilterToMetricList = function (filters) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_18___default.a.forEach(filters, function (filter) {
      if (filter !== '') {
        filteredMetrics = lodash__WEBPACK_IMPORTED_MODULE_18___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_18___default.a.filter(filteredMetrics, function (metric) {
  ...
  QueryEditor.prototype.checkMetricAndRefresh = function () {
    if (this.query.metric && this.query.metric.key && !lodash__WEBPACK_IMPORTED_MODULE_18___default.a.includes(lodash__WEBPACK_IMPORTED_MODULE_18___default.a.map(this.state.availableMetrics, function (m) {
      return m.key;
  ...
  QueryEditor.prototype.render = function () {
    ...
    var categories = this.allowInfraExplore ? _lists_metric_categories__WEBPACK_IMPORTED_MODULE_19__["default"] : _lists_metric_categories__WEBPACK_IMPORTED_MODULE_19__["default"].filter(function (category) {
      return category.key !== _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["INFRASTRUCTURE_EXPLORE"];
    });
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      ...
      loadEntityTypes: this.loadEntityTypes,
      updateQueryTypes: this.updateQueryTypes
    }), query.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["INFRASTRUCTURE_EXPLORE"] && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Infrastructure_Explore__WEBPACK_IMPORTED_MODULE_9__["Explore"], {
      query: query,
      queryTypes: this.state.queryTypes,
      datasource: this.props.datasource,
      onRunQuery: this.props.onRunQuery,
      ...
      datasource: this.props.datasource
    }), query.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["ANALYZE_WEBSITE_METRICS"] && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Analyze_WebsiteMetrics__WEBPACK_IMPORTED_MODULE_17__["WebsiteMetrics"], {
      query: query,
      onRunQuery: this.props.onRunQuery,
      onChange: this.props.onChange,
      updateMetrics: this.updateMetrics,
      ...
      onChange: this.props.onChange,
      datasource: this.props.datasource
    }), query.metricCategory.key !== _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["SLO_INFORMATION"] && query.metricCategory.key !== _GlobalVariables__WEBPACK_IMPORTED_MODULE_2__["INFRASTRUCTURE_EXPLORE"] && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Metric_Metric__WEBPACK_IMPORTED_MODULE_13__["default"], {
      query: query,
      onChange: this.props.onChange,
      onRunQuery: this.props.onRunQuery,
      updateMetrics: this.updateMetrics,
...
/* harmony import */ var _DataSource_Website__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./DataSource_Website */ "./datasources/DataSource_Website.ts");
/* harmony import */ var _lists_metric_categories__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../lists/metric_categories */ "./lists/metric_categories.ts");
...
/* harmony import */ var _util_aggregation_util__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../util/aggregation_util */ "./util/aggregation_util.ts");
/* harmony import */ var _util_target_util__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../util/target_util */ "./util/target_util.ts");
/* harmony import */ var _util_instana_version__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../util/instana_version */ "./util/instana_version.ts");
/* harmony import */ var _util_queryInterval_check__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../util/queryInterval_check */ "./util/queryInterval_check.ts");
/* harmony import */ var _migration__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../migration */ "./migration.ts");
/* harmony import */ var _util_analyze_util__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../util/analyze_util */ "./util/analyze_util.ts");
...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.dataSourceWebsite = new _DataSource_Website__WEBPACK_IMPORTED_MODULE_14__["DataSourceWebsite"](instanceSettings.jsonData);
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        , Promise.all(options.targets.map(function (target) {
          ...
          if (!target.metricCategory) {
            target.metricCategory = _lists_metric_categories__WEBPACK_IMPORTED_MODULE_15__["default"][0];
          }
          ...
          } else if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["INFRASTRUCTURE_EXPLORE"]) {
          ...
          return Promise.resolve(Object(_util_target_util__WEBPACK_IMPORTED_MODULE_18__["emptyResultData"])(target.refId));
        })).then(function (targetData) {
          var result = [];

          lodash__WEBPACK_IMPORTED_MODULE_16___default.a.each(targetData, function (targetAndData) {
            // Flatten the list as Grafana expects a list of targets with corresponding datapoints.
            var resultData = lodash__WEBPACK_IMPORTED_MODULE_16___default.a.compact(lodash__WEBPACK_IMPORTED_MODULE_16___default.a.flatten(targetAndData.data)); // Also remove empty data items


            _this.cacheResultIfNecessary(lodash__WEBPACK_IMPORTED_MODULE_16___default.a.cloneDeep(resultData), targetAndData.target); // clone to store results without timeshift re-calculation
          ...
          return {
            data: lodash__WEBPACK_IMPORTED_MODULE_16___default.a.flatten(result)
          };
        })];
      });
    });
  ...
  DataSource.prototype.getApplicationServiceEndpointMetrics = function (target, timeFilter) {
    ...
    if (Object(_util_queryInterval_check__WEBPACK_IMPORTED_MODULE_20__["isInvalidQueryInterval"])(timeFilter.windowSize, Object(_util_time_util__WEBPACK_IMPORTED_MODULE_6__["hoursToMs"])(this.options.queryinterval_limit_app_metrics))) {
    ...
    if (target.endpoint && target.endpoint.key) {
      return this.dataSourceEndpoint.fetchEndpointMetrics(target, timeFilter).then(function (response) {
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_22__["readItemMetrics"])(target, response, _this.dataSourceEndpoint.buildEndpointMetricLabel);
      });
      ...
      return this.dataSourceService.fetchServiceMetrics(target, timeFilter).then(function (response) {
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_22__["readItemMetrics"])(target, response, _this.dataSourceService.buildServiceMetricLabel);
      });
      ...
      return this.dataSourceApplication.fetchApplicationMetrics(target, timeFilter).then(function (response) {
        ...
        return Object(_util_analyze_util__WEBPACK_IMPORTED_MODULE_22__["readItemMetrics"])(target, response, _this.dataSourceApplication.buildApplicationMetricLabel);
      });
    }
  ...
  DataSource.prototype.supportsDeltaRequests = function (target) {
    ...
    if (target.metricCategory) {
      if (target.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["SLO_INFORMATION"] || target.metricCategory.key === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["INFRASTRUCTURE_EXPLORE"]) {
        return false;
      }
    }
    ...
    if (!version) {
      return Object(_util_instana_version__WEBPACK_IMPORTED_MODULE_19__["default"])(this.options).then(function (version) {
  ...
  DataSource.prototype.aggregateDataIfNecessary = function (data, target) {
    ...
    if (target.aggregateGraphs) {
      var aggregatedData_1 = Object(_util_aggregation_util__WEBPACK_IMPORTED_MODULE_17__["aggregateTarget"])(data, target);
      newData.push(aggregatedData_1);

      if (!target.hideOriginalGraphs) {
        lodash__WEBPACK_IMPORTED_MODULE_16___default.a.each(data, function (dt) {
  ...
  DataSource.prototype.getDefaultTimeInterval = function (query) {
    ...
    if (category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["BUILT_IN_METRICS"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_METRICS"] || category === _GlobalVariables__WEBPACK_IMPORTED_MODULE_1__["INFRASTRUCTURE_EXPLORE"]) {
...
function () {
  ...
  DataSourceInfrastructure.prototype.fetchExploreEntities = function (target, timeFilter) {
    ...
    return Object(_util_request_handler__WEBPACK_IMPORTED_MODULE_0__["postRequest"])(this.instanaOptions, '/api/infrastructure-monitoring/explore/groups', payload).then(function (res) {
      var result = [];
      ...
      res.data.data.items.forEach(function (entity) {
  ...
  DataSourceInfrastructure.prototype.fetchMetricsForSnapshot = function (snapshotId, timeFilter, rollup, metric) {
    var url = "/api/metrics?metric=" + encodeURIComponent(metric.key) + ("&from=" + timeFilter.from) + ("&to=" + timeFilter.to) + ("&rollup=" + rollup) + "&fillTimeSeries=true" + ("&snapshotId=" + snapshotId);
