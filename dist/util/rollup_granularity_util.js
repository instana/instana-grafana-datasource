System.register(["../lists/granularities", "../lists/rollups", "lodash"], function(exports_1) {
    var granularities_1, rollups_1, lodash_1;
    ...
    function setRollUpValues(target, timeFilter) {
        target.availableTimeIntervals = getPossibleRollups(timeFilter);
        if (!target.timeInterval || !lodash_1.default.find(target.availableTimeIntervals, ['key', target.timeInterval.key])) {
            target.timeInterval = getDefaultMetricRollupDuration(timeFilter);
        }
    }
    exports_1("setRollUpValues", setRollUpValues);
    function setGranularityValues(target, timeFilter) {
    ...
    exports_1("setGranularityValues", setGranularityValues);
    return {
        setters:[
