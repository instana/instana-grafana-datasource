...
import { BUILT_IN_METRICS, CUSTOM_METRICS, INFRASTRUCTURE_ANALYZE, SLO_INFORMATION, SYNTHETIC_MONITORING } from '../../GlobalVariables';
    ...
    return (
      <div>
        ...
        <div hidden={!query.showAdvancedSettings}>
          <div className={'gf-form'} hidden={category === SLO_INFORMATION || category === INFRASTRUCTURE_ANALYZE || category === SYNTHETIC_MONITORING}>
            <FormInput
              queryKeyword
              inputWidth={0}
              label={'Legend format'}
