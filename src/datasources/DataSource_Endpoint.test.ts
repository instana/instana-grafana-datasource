...
describe('Given an endpoint datasource', function() {
  ...
  it('should return endpoints of a service of an application', function() {
    ...
    return axios.get(options.url + '/api/application-monitoring/applications?'
      + timeFilter.windowSize
      + '&to=' + timeFilter.to, {
      headers: {
        Authorization: 'apiToken ' + options.apiToken
      ...
      return axios.get(options.url + '/api/application-monitoring/applications;id=' + applicationId
        + '/services?'
        + timeFilter.windowSize
        + '&to=' + timeFilter.to, {
        headers: {
  ...
  function getEndpointsAndVerify(applicationId: string = '', serviceId: string = '') {
    return axios.get(options.url + '/api/application-monitoring/applications;id=' + applicationId
